...
export function Footer() {
    return (
        <div className="max-w-5xl p-6 mx-auto mt-10 md:-10">
            <div className="justify-between md:flex" id="footer">
                <div>
                    <Image src="/assets/logo.png" width={200} height={40} alt="Logo Bank" />
                    <Reveal>
                        <p className="mt-5 text-primaryDark max-w-[250px]">Seguridad moderna y sofisticada apta para establecimientos públicos y privados.</p>
                    </Reveal>
                </div>
            ...
            <div className="items-center justify-between md:flex">
                <div className="my-3">
                    <Reveal>
                        2024 STARSEARE Seguridad Privada. Todos los derechos reservados.
                    </Reveal>
                </div>
